...
const Schema = require('../schema/outbound_statuses')
const Controller = require('../controller/outbound_statuses')
...
router.post('/', async (req, res, next) => {
	console.log('insert outbound_statuses data : ', req.body)
...
router.put('/:id', validationMiddleware(Schema.update, 'body'), async (req, res, next) => {
	const conditions = {id: req.params.id}
	console.log('edit outbound_statuses data : ', req.body)
