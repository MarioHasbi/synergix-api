...
const view_table = 'view_timelines'
exports.getAll = async (conditions) => { 
    const data = await dbQueryHelper.getAll({ table:view_table, conditions}) 
    return data
};

exports.getDetail = async (conditions) => { 
    const data = await dbQueryHelper.getDetail({ table:view_table, conditions }) 
    return data
}
